        ...
        <form action="{{ route('penulis.update', $penulis->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="mb-2">
                    ...
                    @else
                        <div class="bg-light d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; border-radius: 8px; border: 1px solid #e9ecef;">No Image</div>
                    @endif
                </div>
                ...
                <div class="form-text" style="font-size: 12px;">Format: JPG, JPEG, PNG. Max: 2 MB. Kosongkan jika tidak ingin mengubah foto.</div>
